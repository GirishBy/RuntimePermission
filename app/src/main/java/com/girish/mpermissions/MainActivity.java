package com.girish.mpermissions;
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (ActivityCompat.checkSelfPermission(MainActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                    ...
                    Log.i("TEST", "ASK PERMISSION IF BLOCK");

                    if (ActivityCompat.shouldShowRequestPermissionRationale(MainActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {

                        Log.i("TEST", "Show Information about why you need the permission");
                        ...
                        Log.i("TEST", "Previously Permission Request was cancelled with 'Dont Ask Again'");
                        ...
                        Log.i("TEST", "ELSE just request the permission");
                    ...
                    Log.i("TEST", "You already have the permission, just go ahead.");
        ...
        if (requestCode == EXTERNAL_STORAGE_PERMISSION_CONSTANT) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale(MainActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                    ...
                    Log.i("TEST","On Request Permissions Result");
                    ...
                    Log.i("TEST","On Request Permissions Result ELSEEEEEEEEE");
